...
export const TreeView: React.FC<TreeViewProps> = ({ data, onPersonClick }) => {
  ...
  return (
    <div
      className="relative overflow-x-auto overflow-y-visible py-24 pb-32"
      ref={containerRef}
    >
      <div 
        ref={contentRef}
        className="min-w-[2000px] flex flex-col items-center gap-48 relative z-10"
      >
        <div className="absolute left-6 top-0 z-20">
          <div className="bg-white/90 backdrop-blur border border-stone-200 rounded-2xl shadow-sm px-4 py-3">
            ...
            <div className="flex flex-col gap-2 text-xs text-stone-600">
              <div className="flex items-center gap-2">
                <svg width="34" height="10" viewBox="0 0 34 10" aria-hidden="true">
                  <line x1="1" y1="5" x2="33" y2="5" stroke="#607D8B" strokeWidth="2" strokeLinecap="round" />
                </svg>
                <span>Children</span>
              </div>
              <div className="flex items-center gap-2">
